...
constexpr auto CROSS_TRACK_ERROR_VAR = "LIBCIVA_CROSS_TRACK_ERROR_VAR_";
constexpr auto DESIRED_TRACK_VAR = "LIBCIVA_DESIRED_TRACK_VAR_";
constexpr auto EVENT = "LIBCIVA_EVENT";
