...
--|--|--|--|-----------|-----------|-----------|-----------|-------|-------|-------|-------|-------|-------|-------|-------|-----------|----------|----------|----------|---------------------------------------|
W |E |S |N |Right 2nd .|Right 1st .|Right 2nd °|Right 1st °|TO     |FROM   |Rigth 6|Right 5|Right 4|Right 3|Right 2|Right 1||Left 2nd .|Left 1st .|Left 2nd °|Left 1st °|Left 5 |Left 4 |Left 3 |Left 2 |Left 1 |
